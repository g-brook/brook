...
export default {
    ...
    menu: {
        ...
        tunnelConfiguration: {
            ...
            manager: "隧道管理",
            security: "安全设置",
            securityDescription: "配置安全策略和防护规则",
            description: "管理和配置隧道服务器设置管理",
        },
        mySetting: {
            title: "我的设置",
            description:
        ...
        strategy: {
            ...
            status: "状态",
            actions: "操作",
            deleteBlockedTitle: "无法删除策略",
            deleteBlockedDesc: "该策略已绑定到以下隧道配置，请先在隧道配置中解除绑定。",
            whitelist: "白名单",
            blacklist: "黑名单",
            privateOnly: "仅私有(白名单)",
            ilUsesWhitelistTip: "提示：仅私有使用白名单逻辑（仅允许列表中的 IP / CIDR 访问）。",
            add: "添加策略",
            edit: "编辑策略",
            delete: "删除策略",
            rules: "管理规则",
            noStrategies: "暂无 IP 策略",
            noStrategiesDesc: "创建一个 IP 策略来管理访问控制",
        },
        rules: {
            title: "IP 规则",
            ip: "IP / CIDR",
            ...
            add: "添加规则",
            delete: "删除规则",
            placeholder: "输入 IP 地址或 CIDR（例如 192.168.1.1 或 10.0.0.0/24）",
        }
    },
    },
    ...
    configuration: {
        title: "配置管理",
        addTunnelConfig: "添加隧道配置",
        editTunnelConfig: "编辑隧道配置",
        totalConfigs: "共 {count} 个配置",
        totalConfigsTitle: "当前隧道配置总数",
        enabledConfigs: "已启用 {count} 个",
        enabledConfigsTitle: "已启用的隧道配置数量",
        runningConfigs: "运行中 {count} 个",
        runningConfigsTitle: "正在运行的隧道配置数量",
        serialNumber: "序号",
        nameAndTag: "名称和标签",
        download: "下载",
        remotePort: "服务器端口",
        ...
        webNotSet: "未设置 WEB 配置，请配置",
        httpsCertConfig: "HTTPS 证书设置",
        inputCertFilePath: "输入 CertFile 路径",
        inputKeyFilePath: "输入 KeyFile 路径",
        proxyList: "代理配置列表",
        saveConfig: "保存配置",
        domain: "域名",
        paths: "路径",
        ...
        protocols: {
            http: {
                title: "HTTP",
                desc: "标准 Web 代理，适用于普通网页访问"
            },
            https: {
                title: "HTTPS",
                desc: "具有 TLS 加密的安全 Web 代理"
            },
            tcp: {
                title: "TCP",
                desc: "可靠的通用隧道，适用于 SSH、数据库等"
            },
            udp: {
                title: "UDP",
                desc: "低延迟隧道，适用于游戏、流媒体等"
            }
        },
        form: {
            proxyIdPlaceholder: "请输入代理 ID",
            namePlaceholder: "请输入配置名称",
            tagLabel: "标签",
            tagPlaceholder: "请输入标签（可选）",
            portPlaceholder: "请输入端口",
            destPortPlaceholder: "请输入端口（可选）",
            destAddrPlaceholder: "请输入地址（可选）",
        }
    },
    ...
    mysetting: {
        ...
        copyToken: "复制令牌",
        noTokenTitle: "未生成令牌",
        noTokenDesc: "您需要生成一个访问令牌供客户端连接",
        generate: "生成令牌",
        regenerate: "重新生成令牌",
        revoke: "撤销令牌",
        confirmRevoke: "您确定要撤销当前令牌吗？使用此令牌的客户端将无法连接。",
        hideToken: "隐藏令牌",
        showToken: "显示令牌",
        tls: {
            title: "证书",
