  ...
  <div class="min-h-screen flex items-center justify-center">
    <div class="transform">
      <div class="card-container w-96 p-[2px] rounded-2xl relative">
        <div class="absolute -top-3/12 left-1/2 -translate-x-1/2 flex items-center justify-center">
          <div class="relative">
            <div
                class="absolute inset-1 w-10 h-10 rounded-full bg-gradient-to-r from-sky-300 via-blue-400 to-indigo-400 opacity-40 blur-2xl">
            </div>
          </div>
        </div>
        <div
          ...
          <div class="flex flex-1 justify-between">
            <h2 class="text-2xl font-black leading-[1.1] mb-8 tracking-tight"
                style="font-family: 'Nunito', sans-serif">
              <img src="@/assets/font-dark.svg" class="h-auto w-48 relative  drop-shadow-md"/>
            </h2>
